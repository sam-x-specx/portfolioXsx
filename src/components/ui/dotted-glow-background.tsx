...
//   speedMax?: number;
//   speedScale?: number;
//   /** gradient start color (center) — default light blue */
//   gradientFrom?: string;
//   /** gradient end color (edges) — default dark blue */
//   gradientTo?: string;
// };
...
//   speedMax = 1.3,
//   speedScale = 1,
//   gradientFrom = "#000B18",   // light blue (sky-400)
//   gradientTo = "#030712",     // dark navy blue
// }: DottedGlowBackgroundProps) => {
//   const canvasRef = useRef<HTMLCanvasElement | null>(null);
//   const containerRef = useRef<HTMLDivElement | null>(null);
//   const [resolvedColor, setResolvedColor] = useState<string>(color);
...
//       // ── Two-color linear gradient background (bottom-right → top-left) ──
//       const grad = ctx.createLinearGradient(width, height, 0, 0);
